...
export const Navbar = () => {
  const navigation = [{LinkName: "Home", href:"/"}, {LinkName: "About Me", href:"/about"}];
          ...
          {({ open }) => (
            <>
              <div className="flex flex-wrap items-center justify-between w-full lg:w-auto">
                ...
                <DisclosurePanel
                  transition
                  className="origin-top transition duration-200 ease-out data-[closed]:-translate-y-6 data-[closed]:opacity-0 flex flex-wrap w-full my-5 lg:hidden"
                >
                  <>
