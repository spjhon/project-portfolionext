  ...
  return (
    <NextIntlClientProvider messages={messages}>
      ...
      <Container className="bg-barra dark:bg-gradient-to-r from-black  to-slate-800 h-screen max-w-[2592px] max-h-[1750px]">
        ...
        <div className="absolute w-full h-full grid grid-rows-[1fr_2rem_2fr] md:grid-rows-[1fr_2rem_2fr] landscape:grid-cols-[1fr_4rem_1.5fr] landscape:grid-rows-none">
